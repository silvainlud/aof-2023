...
public class Jour2Test extends JourTest<Jour2> {
    ...
    @Override
    protected Jour2 instanceNewJour() {
        return new Jour2();
    }
    ...
    public void testPartie1() {
        ...
        getJour().setCubeConfiguration(cubeConfiguration);
    ...
    public void validatePartie2() {
        ...
        cubeConfiguration.put("blue", 14);
        getJour().setCubeConfiguration(cubeConfiguration);
        Assertions.assertEquals("48", getJour().executePartie2(List.of("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green")));
        Assertions.assertEquals("12", getJour().executePartie2(List.of("Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue")));
        Assertions.assertEquals("1560", getJour().executePartie2(List.of("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red")));
        Assertions.assertEquals("630", getJour().executePartie2(List.of("Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red")));
        Assertions.assertEquals("36", getJour().executePartie2(List.of("Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green")));
    }
}
